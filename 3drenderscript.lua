...
local function createLoadingScreen()
    ...
    loadingFrame.BackgroundColor3 = Color3.new(0, 0, 0) -- черный цвет фона
    ...
    loadingText.BackgroundTransparency = 1 -- прозрачный фон
    loadingText.TextColor3 = Color3.new(1, 1, 1) -- белый цвет текста
